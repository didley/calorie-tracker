  ...
  return (
    <div className="flex justify-center w-full max-w-sm bg-white p-3 m-2 rounded-lg shadow-lg">
      ...
      <button
        ...
        className="text-center text-sm appearance-none bg-gray-200 border text-gray-700 py-1 px-3 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500 hover:text-red-500"
      >
        {"<"}
      </button>
      <DatePicker
        ...
        className="w-24 mx-1 text-center text-sm appearance-none border text-gray-700 py-1 px-2 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500 hover:text-red-500"
      />
